...
- Before running `/king-bloom-config` to understand the landscape
...
|-------|------------------|-----------|--------|
| King (You) | `claude-opus-4-6` | L6 | Strategic decisions, final review |
| Minister (Manager) | `claude-sonnet-4-6` | L4-L5 | Task orchestration; Opus is overkill here |
| Priest (Strategist) | `claude-opus-4-6` | L5-L6 | Deep QC, architecture evaluation |
| Citizen 1–7 | Configured via `capability_tiers` | L1-L3 | Workers — routed by Bloom level |
...
Or tell the King: "set up capability tiers for my subscription"
